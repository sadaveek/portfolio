...
function NavBar() {
    ...
    return (
        <div className="font-mona font-extralight flex justify-between items-center animate-fade-down animate-delay-[5000ms]">
            <a href="#Home">
                <img id="myLogo" alt="Website Logo" src={Logo} className="size-16 ml-3 navbar-elements" />
            </a>
            ...
            <div onClick={handleNav} ref = {toggleRef} className="block sm:hidden">
                {nav ? (
                    <img id="hamburgerLogo" src={HamburgerMenu} className="size-10 navbar-elements mr-2 justify-end" />
                ) : (
                    <img id="hamburgerLogo" src={HamburgerClose} className="size-10 navbar-elements mr-2 justify-end" />
                )}
            </div>
            <div
                ref={navRef}
            ...
            >
                <ul className="flex-col pt-24 space-y-5 text-xl pl-6 inline-block">
                    ...
                    <li className="navbar-elements"><a href="#Experience" onClick={handleNav}>experience</a></li>
                    <li className="navbar-elements"><a href="#Contact" onClick={handleNav}>contact</a></li>
                </ul>
            </div>
        </div>
    );
